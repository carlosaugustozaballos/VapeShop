...
<form >	 
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="descripcion" value="<?php echo $mostrar['descripcion'] ?>">
</div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="estado" value="<?php echo $mostrar['precio'] ?>">
  </div>
...
<?php  
      ...
      $Sentencia2="Update detallepedido SET descripcion='".$desc."',productos='".$pro."',precio='".$pre"' where id_Pedido = '".$id2."';";
